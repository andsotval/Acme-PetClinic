...
class HU016 extends Simulation {
	...
	val scnHU016_ListAcceptedVisits = scenario("scnHU016_ListAcceptedVisits").exec(
		Home.home,
		Login.login,
	...
	setUp(
		scnHU016_ListAcceptedVisits.inject(rampUsers(5000) during (100 seconds))
